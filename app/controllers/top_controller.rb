class TopController < ApplicationController
  ...
  def figure
    ...
    @figures << Figure.new(
                "平山醇左衛門", "hirayama.jpg", "大砲技術を佐賀にもたらした", "技術者", 1809, 1843, '#429ade',
                "<p>工事中</p>"
                )
    @figures << Figure.new(
                "島義勇", "shima.jpg", "蝦夷地開拓の父", "官吏", 1822, 1874, '#d43a52',
                "<p>工事中</p>"
                )
    @figures << Figure.new(
                "大木喬任", "oki.jpg", "初代文部卿、6大教育家のひとり", "政治家", 1832, 1899, '#d43a52',
                "<p>工事中</p>"
                )
    @figures << Figure.new(
                "江藤新平", "eto.jpg", "維新に尽くし、佐賀の乱に斃れた", "政治家", 1832, 1899, '#d43a52',
                "<p>工事中</p>"
                )
    @figures << Figure.new(
                "辰野金吾", "tatsuno.jpg", "東京駅、日本銀行本店を設計", "建築家", 1854, 1919, '#c6d443',
                "<p>工事中</p>"
                )
    @figures << Figure.new(
    ...
    @figures << Figure.new(
                "納富介次郎", "nodomi.jpg", "4校の工芸学校を創立", "工芸デザイナー", 1844, 1918, '#c6d443',
                "<p>工事中</p>"
                )
    @figures << Figure.new(
    ...
    @figures << Figure.new(
                "副島種臣", "soejima.jpg", "書家としても活躍した外務卿", "政治家", 1828, 1905, '#d43a52',
                "<p>工事中</p>"
                )
    @figures << Figure.new(
    ...
    @figures << Figure.new(
                "枝吉神陽", "edayoshi.jpg", "尊皇倒幕を論じ志士を導いた", "国学者", 1822, 1862, '#c6d443',
                "<p>工事中</p>"
                )
    @figures << Figure.new(
                "古賀穀堂", "koga.jpg", "直正を育て、教育を重視した学者", "佐賀藩年寄", 1778, 1836, '#d43a52',
                "<p>工事中</p>"
                )
